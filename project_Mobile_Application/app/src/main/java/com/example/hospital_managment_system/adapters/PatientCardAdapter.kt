...
class PatientCardAdapter(private val context: Context, private val dataSource: ArrayList<UserPatient>) : BaseAdapter() ,
    Filterable {

    private val inflater: LayoutInflater = context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
    private val mListAppInfoFiltered: ArrayList<UserPatient> = dataSource
...
//        holder.mImageView!!.setImageResource(image[position])
        ...
        holder.mSubHeader!!.setText(map.dateOfBirth)
