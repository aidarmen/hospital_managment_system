...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener, Observer {

    lateinit var documentationFragment: DocumentationFragment
    lateinit var myProfileFragment: MyProfileFragment
    lateinit var searchForDoctors: SearchForDoctorsFragment
            ...
            rootRef.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.child("Users").child("Patients").hasChild(uid)) {
                        ...
                        startActivity(Intent(this@MainActivity, MainActivityDoctor::class.java))
                        finish()
                    } else  {
                        startActivity(Intent(this@MainActivity, LoginActivity::class.java))
                        finish()
...
//        setDataToView(user!!)
        ...
        searchForDoctors = SearchForDoctorsFragment()
        supportFragmentManager
            .beginTransaction()
            .replace( R.id.frame_layout,searchForDoctors)
